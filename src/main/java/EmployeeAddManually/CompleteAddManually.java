...
public class CompleteAddManually {
	public static void main(String[] args) throws InterruptedException, IOException {
		
		ExtentHtmlReporter htmlReporter=new ExtentHtmlReporter("AdiExtentReport21OCT24-3rd.html");
...
//		extent.flush();
		...
		pm.mandatoryFields(row);	
		pm.nonmandatoryPrimaryFields(driver,row);
//		EmployeeAddManually.log(Status.PASS, "primaryDetails section fields successfully filled" );
//		extent.flush();
		
		ei.employmentInfoMandatoryFields(driver,row);
...
//		extent.flush();
        ...
        XSSFCell cell2 = (XSSFCell) row2.createCell(colNum);
...
//	public static void callAllClassObjects(WebDriver driver) {
//		LandingPage landing =new LandingPage(driver);
//		PrimaryDetails pm=new PrimaryDetails(driver);
//		EmploymentInfo ei =new EmploymentInfo(driver);
//		Wages w=new Wages(driver);
